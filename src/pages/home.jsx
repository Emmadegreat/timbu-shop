...
const Home = () => {
    ...
    if (isError) return <div className='flex justify-center py-4 text-[1.2rem]'>Error fetching products</div>;
    if (isEmpty) return <div className='flex justify-center py-4 text-[1.2rem]'>No products found</div>;
